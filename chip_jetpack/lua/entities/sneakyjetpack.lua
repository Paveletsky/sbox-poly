...
ENT.Category = 'Политопия'
ENT.IconOverride = 'poly/jet.png'
...
function ENT:Initialize()
	...
	if SERVER then
		self:SetModel( "models/gmod_tower/jetpack.mdl" )
		self:InitPhysics()
...
if SERVER then
	...
	function ENT:GetEffectsOffset()
		...
		return Vector( self:GetPos().x, 50, 0 ) + angup * 5, angup
	end
