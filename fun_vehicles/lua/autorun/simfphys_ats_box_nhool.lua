local V = {
	Name = "Ford F-650 'N-Hool'",
	Model = "models/ats/vehicles/box_nhool.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_box_nhool", V )
...
list.Set( "simfphys_lights", "ats_box_nhool", light_table)