local V = {
	Name = "Ford F-650",
	Model = "models/ats/vehicles/box_plain.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_box_plain", V )
...
list.Set( "simfphys_lights", "ats_box_plain", light_table)