local V = {
	Name = "Chevrolet Caprice PPV California Highway Patrol",
	Model = "models/ats/vehicles/capr_highway_patrol.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_capr_highway_patrol", V )