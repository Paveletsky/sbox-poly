local V = {
	Name = "Chevrolet Caprice PPV New Mexico State Police",
	Model = "models/ats/vehicles/capr_nm_hp.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_capr_nm_hp", V )
...
list.Set( "simfphys_lights", "ats_capr_nm_hp", light_table)