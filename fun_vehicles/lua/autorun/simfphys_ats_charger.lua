local V = {
	Name = "Dodge Charger (2011)",
	Model = "models/ats/vehicles/charger.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_charger", V )
...
list.Set( "simfphys_lights", "ats_charger", light_table)