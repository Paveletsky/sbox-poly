local V = {
	Name = "Dodge Charger Albuquerque Police",
	Model = "models/ats/vehicles/charger_albuquerque_pd.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_charger_albuquerque_pd", V )