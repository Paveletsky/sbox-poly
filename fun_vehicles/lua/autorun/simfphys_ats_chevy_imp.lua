local V = {
	...
	Model = "models/ats/vehicles/chevy_imp.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_chevy_imp", V )
...
list.Set( "simfphys_lights", "ats_chevy_imp", light_table)