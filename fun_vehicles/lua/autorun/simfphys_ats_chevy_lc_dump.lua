local V = {
	Name = "Chevrolet Low Cab Forward Dump Truck",
	Model = "models/ats/vehicles/chevy_lc_dump.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_chevy_lc_dump", V )
...
local light_table = {
	...
	Rearlight_sprites = {
		...
		--
		{
			pos = Vector(-134.92,0,-7.88),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,0,0,125),
		},
		{
			pos = Vector(-134.92,8.34,-7.88),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,0,0,125),
		},
...
list.Set( "simfphys_lights", "ats_chevy_lc_dump", light_table)