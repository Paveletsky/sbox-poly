local V = {
	...
	Model = "models/ats/vehicles/chevy_lc_flatbed.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_chevy_lc_flatbed", V )
...
list.Set( "simfphys_lights", "ats_chevy_lc_flatbed", light_table)