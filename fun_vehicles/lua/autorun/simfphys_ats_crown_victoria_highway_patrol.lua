local V = {
	Name = "Ford Crown Victoria California Highway Patrol",
	Model = "models/ats/vehicles/crown_victoria_police.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_crown_victoria_highway_patrol", V )