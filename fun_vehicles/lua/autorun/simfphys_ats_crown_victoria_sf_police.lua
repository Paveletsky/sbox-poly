local V = {
	Name = "Ford Crown Victoria San Francisco Police",
	Model = "models/ats/vehicles/crown_victoria_police2.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_crown_victoria_sf_police", V )