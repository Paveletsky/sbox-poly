local V = {
	...
	Model = "models/ats/vehicles/crown_victoria_taxi.mdl",
	...
	Members = {
		...
		CustomWheelModel = "models/ats/vehicles/wheel/car/generic/18in_taxi.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_crown_victoria_taxi", V )