local V = {
	Name = "Dodge Ram 2500 Escort Vehicle",
	...
	Members = {
		...
		OnSpawn = function(ent)
            if ent.GetCenterposition != nil then
                ent:SetCenterposition(Vector(-90.18,0,12.12))
                ent:SetTrailerCenterposition(Vector(-90.18,0,12.12))
            end
        end,
		
		EnginePos = Vector(116,0,15),
		
		LightsTable = "ats_dodge_ram_escort",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_dodge_ram_escort", V )
...
list.Set( "simfphys_lights", "ats_dodge_ram_escort", light_table)