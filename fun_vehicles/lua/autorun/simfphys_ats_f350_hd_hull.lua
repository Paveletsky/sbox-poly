local V = {
	Name = "Ford F-350",
	Model = "models/ats/vehicles/f350_hd_hull.mdl",
	...
	Members = {
		...
		FuelFillPos = Vector(-108.46,50.12,-1.45),
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_f350_hd_hull", V )
...
local light_table = {
	...
	L_RearLampPos = Vector(-112.71,39.1,-15.94),
	L_RearLampAng = Angle(25,180,0),
	R_RearLampPos = Vector(-112.71,-39.1,-15.94),
	...
	Rearlight_sprites = {
		...
		--
		{
			pos = Vector(-118.45,0,4),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,0,0,255),
		},
		{
			pos = Vector(-118.45,9.46,4),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,0,0,255),
		},
...
list.Set( "simfphys_lights", "ats_f350_hd_hull", light_table)