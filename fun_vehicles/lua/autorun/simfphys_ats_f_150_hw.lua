local V = {
	Name = "Ford F-150 Highway Maintenance",
	Model = "models/ats/vehicles/f_150_hw.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_f_150_hw", V )
...
list.Set( "simfphys_lights", "ats_f_150_hw", light_table)