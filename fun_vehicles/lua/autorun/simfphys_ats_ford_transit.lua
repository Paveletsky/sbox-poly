local V = {
	Name = "Ford Transit",
	Model = "models/ats/vehicles/ford_transit.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_ford_transit", V )
...
list.Set( "simfphys_lights", "ats_ford_transit", light_table)