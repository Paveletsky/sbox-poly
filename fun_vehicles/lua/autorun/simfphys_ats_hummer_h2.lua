...
list.Set( "simfphys_vehicles", "sim_fphys_ats_hummer_h2", V )
...
local light_table = {
	...
	Rearlight_sprites = {
		...
		{
			pos = Vector(-87.24,0,39.28),
			material = "sprites/light_ignorez",
			size = 20,
			color = Color(255,0,0,255),
		},
		{
			pos = Vector(-87.24,8.93,39.28),
			material = "sprites/light_ignorez",
			size = 20,
			color = Color(255,0,0,255),
		},
...
list.Set( "simfphys_lights", "ats_hummer_h2", light_table)