local V = {
	Name = "Kenworth T680 Duty Day Cab",
	Model = "models/ats/vehicles/kenworth_t680_ai_a.mdl",
	...
	Members = {
		...
		OnSpawn = function(ent)
            if ent.GetCenterposition != nil then
                ent:SetCenterposition(Vector(-91,0,0))
                ent:SetTrailerCenterposition(Vector(-91,0,0))
            end
        end,
		
		EnginePos = Vector(135,0,15),
		
		LightsTable = "ats_kenworth_t680_ai_a",
		...
		CustomWheelPosFL = Vector(89.32,45.85,-32),
		CustomWheelPosFR = Vector(89.32,-45.85,-32),
		CustomWheelPosML = Vector(-64.12,39.58,-30),
		CustomWheelPosMR = Vector(-64.12,-39.58,-30),		
		CustomWheelPosRL = Vector(-120.59,39.58,-30),
		CustomWheelPosRR = Vector(-120.59,-39.58,-30),
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_kenworth_t680_ai_a", V )
...
local light_table = {
	...
	L_RearLampPos = Vector(-156.49,12.88,-14.92),
	L_RearLampAng = Angle(25,180,0),
	R_RearLampPos = Vector(-156.49,-12.88,-14.92),
	...
	Headlight_sprites = {   -- lowbeam
		...
		{
			pos = Vector(54.56,0,79),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
		{
			pos = Vector(53.31,9.1,79),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
...
list.Set( "simfphys_lights", "ats_kenworth_t680_ai_a", light_table)