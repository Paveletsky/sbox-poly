local V = {
	Name = "Kenworth W900 Day Cab",
	Model = "models/ats/vehicles/kenworth_w900_ai_a.mdl",
	...
	Members = {
		...
		OnSpawn = function(ent)
            if ent.GetCenterposition != nil then
                ent:SetCenterposition(Vector(-91.49,0,-2.35))
                ent:SetTrailerCenterposition(Vector(-91.49,0,-2.35))
            end
        end,
		
		EnginePos = Vector(160,0,20),
		
		LightsTable = "ats_kenworth_w900_ai_a",
		...
		CustomWheelPosML = Vector(-67.38,40.27,-33),
		CustomWheelPosMR = Vector(-67.38,-40.27,-33),		
		CustomWheelPosRL = Vector(-123.84,40.27,-33),
		CustomWheelPosRR = Vector(-123.84,-40.27,-33),
		...
		FuelFillPos = Vector(82.71,42.65,-3.08),
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_kenworth_w900_ai_a", V )
...
local light_table = {
	...
	L_RearLampPos = Vector(-161.17,13.05,-14.98),
	L_RearLampAng = Angle(25,180,0),
	R_RearLampPos = Vector(-161.17,-13.05,-14.98),
...
list.Set( "simfphys_lights", "ats_kenworth_w900_ai_a", light_table)