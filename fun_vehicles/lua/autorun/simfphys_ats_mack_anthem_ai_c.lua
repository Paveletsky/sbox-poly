local V = {
	Name = "Mack Anthem 70' Sleeper",
	Model = "models/ats/vehicles/mack_anthem_ai_c.mdl",
	...
	Members = {
		...
		OnSpawn = function(ent)
            if ent.GetCenterposition != nil then
                ent:SetCenterposition(Vector(-127.73,0,-18))
                ent:SetTrailerCenterposition(Vector(-127.73,0,-18))
            end
        end,
		
		EnginePos = Vector(149,0,-6),
		
		LightsTable = "ats_mack_anthem_ai_c",
		...
		CustomWheelPosML = Vector(-108.46,38.13,-50),
		CustomWheelPosMR = Vector(-108.46,-38.13,-50),		
		CustomWheelPosRL = Vector(-163,38.13,-50),
		CustomWheelPosRR = Vector(-163,-38.13,-50),
		...
		Attachments = {
			{
				model = "models/ats/vehicles/mack_anthem_ai_c_steps.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_mack_anthem_ai_c", V )
...
local light_table = {
	...
	Headlight_sprites = {   -- lowbeam
		...
		{
			pos = Vector(89.77,0,54.63),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
		{
			pos = Vector(89.54,8,54.63),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
		{
			pos = Vector(86.73,27.8,54.57),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
...
list.Set( "simfphys_lights", "ats_mack_anthem_ai_c", light_table)