local V = {
	Name = "Mack RD-690 Dump Truck",
	Model = "models/ats/vehicles/mack_dump.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_mack_dump", V )
...
list.Set( "simfphys_lights", "ats_mack_dump", light_table)