local V = {
	Name = "Mack RD-690 Cement Mixer",
	Model = "models/ats/vehicles/mack_mix.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_mack_mix", V )
...
local light_table = {
	...
	L_RearLampPos = Vector(-200.48,12.61,-12.88),
	L_RearLampAng = Angle(25,180,0),
	R_RearLampPos = Vector(-200.48,-12.61,-12.88),
	...
	Rearlight_sprites = {
		...
		{
			pos = Vector(-223.99,0,98.8),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,0,0,255),
		},
		{
			pos = Vector(-223.99,7.92,98.8),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,0,0,255),
		},
...
list.Set( "simfphys_lights", "ats_mack_mix", light_table)