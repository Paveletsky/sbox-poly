local V = {
	Name = "Ford Mustang MkVI Hardtop",
	...
	Members = {
		...
		LightsTable = "ats_mustang_2015_hardtop",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_mustang_2015_hardtop", V )
...
list.Set( "simfphys_lights", "ats_mustang_2015_hardtop", light_table)