...
list.Set( "simfphys_vehicles", "sim_fphys_ats_old_wrangler", V )

local light_table = {
	-- projected texture / lamp pos   - front
	L_HeadLampPos = Vector(78.5,23.96,16.85),
	L_HeadLampAng = Angle(17,0,0),
	R_HeadLampPos = Vector(78.5,-23.96,16.85),
	R_HeadLampAng = Angle(10,0,0),
	
	-- projected texture - rear
	L_RearLampPos = Vector(-75,32.35,21.96),
	L_RearLampAng = Angle(25,180,0),
	R_RearLampPos = Vector(-75,-32.35,21.96),
	R_RearLampAng = Angle(25,180,0),
	
	Headlight_sprites = {   -- lowbeam
		{
			pos = Vector(78.5,23.96,16.85),
	...
	Headlamp_sprites = {
		{pos = Vector(78.5,23.96,16.85),size = 100,material = "sprites/light_ignorez"},
		{pos = Vector(78.5,-23.96,16.85),size = 100,material = "sprites/light_ignorez"},
	},
	
	FogLight_sprites = {
		{
			pos = Vector(87.19,12.79,0.25),
			material = "sprites/light_ignorez",
			size = 50,
			color = Color(255,238,200,255),
		},
	...
	Turnsignal_sprites = {
		Left = {
			{
				pos = Vector(79.99,25.93,8.36),
				material = "sprites/light_ignorez",
				size = 50,
				color = Color(255,135,0,255),
			},
			{
				pos = Vector(75.93,45.16,12.81),
				material = "sprites/light_ignorez",
				size = 50,
				color = Color(255,135,0,255),
			},
			{
				pos = Vector(-73.1,35.72,20.33),
				material = "sprites/light_ignorez",
				size = 50,
				color = Color(255,0,0,255),
			},
...
list.Set( "simfphys_lights", "ats_wrangler", light_table)