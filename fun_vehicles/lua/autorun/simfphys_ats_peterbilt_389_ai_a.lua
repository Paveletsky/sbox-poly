local V = {
	Name = "Peterbilt 389 Day Cab",
	Model = "models/ats/vehicles/peterbilt_389_ai_a.mdl",
	...
	Members = {
		...
		OnSpawn = function(ent)
            if ent.GetCenterposition != nil then
                ent:SetCenterposition(Vector(-102,0,0.71))
                ent:SetTrailerCenterposition(Vector(-102,0,0.71))
            end
        end,
		
		EnginePos = Vector(147,0,21),
		
		LightsTable = "ats_peterbilt_389_ai_a",
		...
		CustomWheelPosFL = Vector(118,45.52,-32),
		CustomWheelPosFR = Vector(118,-45.52,-32),
		CustomWheelPosML = Vector(-83.56,39.14,-30),
		CustomWheelPosMR = Vector(-83.56,-39.14,-30),		
		CustomWheelPosRL = Vector(-140,39.14,-30),
		CustomWheelPosRR = Vector(-140,-39.14,-30),
		...
		snd_horn = "ats/vehicles/horns/horn_peterbilt_389.wav",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_peterbilt_389_ai_a", V )
...
local light_table = {
	...
	L_RearLampPos = Vector(-168.25,12.62,-16),
	L_RearLampAng = Angle(25,180,0),
	R_RearLampPos = Vector(-168.25,-12.62,-16),
...
list.Set( "simfphys_lights", "ats_peterbilt_389_ai_a", light_table)