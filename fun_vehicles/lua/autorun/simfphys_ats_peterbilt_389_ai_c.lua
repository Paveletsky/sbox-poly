local V = {
	Name = "Peterbilt 389 Ultra Cab Sleeper",
	Model = "models/ats/vehicles/peterbilt_389_ai_c.mdl",
	...
	Members = {
		...
		LightsTable = "ats_peterbilt_389_ai_c",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_peterbilt_389_ai_c", V )
...
local light_table = {
	...
	Headlight_sprites = {   -- lowbeam
		...
		{
			pos = Vector(56.27,0,75.56),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
		{
			pos = Vector(55.31,9.32,75.48),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
...
list.Set( "simfphys_lights", "ats_peterbilt_389_ai_c", light_table)