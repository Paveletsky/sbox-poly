local V = {
	Name = "Peterbilt 579 Stand Up Sleeper",
	Model = "models/ats/vehicles/peterbilt_579_ai_b.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_peterbilt_579_ai_b", V )
...
local light_table = {
	...
	L_RearLampPos = Vector(-222.54,13.81,-15.42),
	L_RearLampAng = Angle(25,180,0),
	R_RearLampPos = Vector(-222.54,-13.81,-15.42),
	...
	Headlight_sprites = {   -- lowbeam
		...
		{
			pos = Vector(59.29,0,73.86),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
		{
			pos = Vector(59.29,7.12,73.86),
			material = "sprites/light_ignorez",
			size = 30,
			color = Color(255,135,0,255),
		},
...
list.Set( "simfphys_lights", "ats_peterbilt_579_ai_b", light_table)