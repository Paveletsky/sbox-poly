local V = {
	...
	Members = {
		...
		CustomWheelModel = "models/ats/vehicles/wheel/tractor/front3.mdl",
		CustomWheelModel_R = "models/ats/vehicles/wheel/tractor/rear3.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_ats_tractor3", V )